...
## 🔧 GitHub'a İlk Kez Yükleme Adımları

### Ön Koşul
- [Git](https://git-scm.com/download/win) kurulu olmalı
- [GitHub hesabı](https://github.com) oluşturulmuş olmalı

### 1. GitHub'da Yeni Depo Aç 

1. [github.com/new](https://github.com/new) adresine git
2. **Repository name:** `kafatasi` (veya istediğiniz isim)
3. **Visibility:** Public veya Private
4. **"Add a README file"** kutusunu **işaretleme** (zaten var)
5. **Create repository** tıkla

### 2. Yerel Klasörde Git Başlat

Proje klasöründe PowerShell veya Komut İstemi aç:

```bash
git init
git add .
git commit -m "ilk surum: brakisefali tespit sistemi"
```
...
`venv/` ve `__pycache__/` klasörlerinin GitHub'da **görünmediğini** doğrulayın.
...
## 📝 Klonlayan Kullanıcı İçin Kurulum Özeti
...
# 3. Uygulamayı başlat
run.bat               # Windows
# veya: .\venv\Scripts\python.exe main.py
```
